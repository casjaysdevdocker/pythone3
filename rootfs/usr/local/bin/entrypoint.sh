...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211131218-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  entrypoint.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Nov 13, 2022 12:18 EST
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for python2
...
__heath_check() {
  ...
  start-python2.sh healthcheck || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-python2}"
